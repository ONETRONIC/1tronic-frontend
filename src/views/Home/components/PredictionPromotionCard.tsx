...
import { Card, CardBody, ArrowForwardIcon, Link, Button, Text, Skeleton, Flex } from 'components/_uikit'
  ...
  return (
    <StyledPredictionCard>
      <CardBody>
        ...
        <Link href="https://1tronic.io/prediction" id="homepage-prediction-cta">
