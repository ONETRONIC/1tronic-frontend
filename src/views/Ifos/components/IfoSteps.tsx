...
import { Stepper, Step, StepStatus, Card, CardBody, Heading, Text, Button, Link, OpenNewIcon } from 'components/_uikit'
        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small mb="16px">
              {t('You’ll need an active 1TronicSwap Profile to take part in an IFO!')}
            </Text>
            {isStepValid ? (
