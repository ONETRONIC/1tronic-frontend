...
import { Button, Text, CheckmarkIcon, CogIcon, Input, Toggle, LinkExternal, useTooltip } from 'components/_uikit'
import { useDispatch, useSelector } from 'react-redux'
import styled from 'styled-components'
import { TokenList, Version } from 'utils/@uniswap/token-lists'
...
const ListRow = memo(function ListRow({ listUrl }: { listUrl: string }) {
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <div>
      <Text color="background">{list && listVersionLabel(list.version)}</Text>
          ...
          <Card padding="12px 20px">
            <RowBetween>
              ...
              {isImported ? (
                ...
                <Button width="fit-content" onClick={handleImport} variant="contrast"> 
                  {t('Import')}
                </Button>
              )}
            </RowBetween>
